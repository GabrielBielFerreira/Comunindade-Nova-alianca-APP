            ...
            builder: (context, constraints) {
              ...
              if (constraints.maxWidth < 520) {
                return Column(
                  ...
                  mainAxisSize: MainAxisSize.min,
                  children: [textos, const SizedBox(height: 12), botao],
                );
              }
          ...
          child: ListTile(
            ...
            subtitle: Column(
              ...
              children: [
                ...
                Text(a.conteudo, maxLines: 2, overflow: TextOverflow.ellipsis),
                  ...
                  onPressed: () => _executar(
                    ...
                    () => ref
                        ...
                        .definirCampanhaStatus(
                          c.id,
                          c.status == 'ativa' ? 'encerrada' : 'ativa',
                        ),
                ...
                children: [
                  ...
                  TextField(
                    ...
                    decoration: const InputDecoration(
                      labelText: 'Meta (R\$)',
                      helperText:
                          'Opcional. Deixe vazio para não definir meta.',
                    ),
                  ),
                  ListTile(
                    contentPadding: EdgeInsets.zero,
...
class _MinisteriosTelaState extends ConsumerState<MinisteriosTela> {
              ...
              children: [
                ...
                Wrap(
                  ...
                  children: [
                    ...
                    Etiqueta(
                      texto: m.publico ? 'Público' : 'Somente membros',
                      cor: m.publico ? Cores.info : Cores.corpo,
                    ),
                  ],
                ),
              ],
  ...
  Future<void> _abrirForm(Ministerio? ministerio) async {
    ...
    MembroPainel? lider;
    var publico = ministerio?.publico ?? true;
    ...
    final salvar = await showDialog<bool>(
      ...
      builder: (d) => StatefulBuilder(
        builder: (d, setState) => AlertDialog(
          title: Text(
            ministerio == null ? 'Novo ministério' : 'Editar ministério',
          ),
          content: SizedBox(
            width: 520,
            child: SingleChildScrollView(
...
class _DevocionaisTelaState extends ConsumerState<DevocionaisTela> {
              ...
              children: [
                ...
                Wrap(
                  ...
                  children: [
                    ...
                    Etiqueta(
                      texto: dv.publico ? 'Público' : 'Somente membros',
                      cor: dv.publico ? Cores.info : Cores.corpo,
                    ),
                    Etiqueta(
                      texto: _dataCurta.format(dv.data),
                      cor: Cores.muted,
                    ),
  ...
  Future<void> _abrirForm(Devocional? devocional) async {
    ...
    var publico = devocional?.publico ?? true;
